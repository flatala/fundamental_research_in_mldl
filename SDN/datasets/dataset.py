...
from datasets.ucf101 import UCF101, UCF101_human_msk, UCF101_bkgmsk, UCF101_adv, UCF101_adv_msk
...
def get_training_set(opt, spatial_transform, temporal_transform,
    ...
    if opt.dataset == 'kinetics':
        ...
        training_data_1 = UCF101_adv(
            ...
            place_pred_path=opt.place_pred_path,
            is_place_soft_label=opt.is_place_soft)
        training_data_2 = UCF101_human_msk(
            opt.video_path,
            opt.annotation_path,
            'training',
            spatial_transform=spatial_transform,
...
def get_validation_set(opt, spatial_transform, temporal_transform,
    ...
    # Validation loader for adverserial UCF
    # TODO: do the same for adv_mask
    # added this - Franek
    elif opt.dataset == 'ucf101_adv':
        validation_data = UCF101_adv(
            opt.video_path,
            opt.annotation_path,
            'validation',
            opt.n_val_samples,
